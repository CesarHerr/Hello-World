...
**[Hello-World]** Is a practice where I put my knowledge about all of the tools and best practices that I learned these days. I'm testing the linters of html/css
...
```
  cd my-folder
  git clone https://github.com/CesarHerr/Hello-World.git
```
...
[Implementation](https://github.com/microverseinc/curriculum-transversal-skills/blob/main/documentation/hello_microverse_project.md) 
